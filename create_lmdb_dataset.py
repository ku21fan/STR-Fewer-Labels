...
def createDataset_with_ValidTestset(inputPath, gtFile, outputPath, dataset_name, validset_percent=10, testset_percent=0, random_seed=1111, checkValid=True):
    """
    Create LMDB dataset for training and evaluation.
    ARGS:
        inputPath  : input folder path where starts imagePath
    ...
    print(f'# Train dataset: {num_train_dataset}, # valid datast: {num_valid_dataset}, and # test datast: {num_test_dataset}')
